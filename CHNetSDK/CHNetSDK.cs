    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public struct NET_DVR_WORKSTATE_V40
        {
            ...
            public uint[] byAudioInChanStatus;		//按位表示语音通道的状态 0-未使用，1-使用中，第0位表示第1个语音通道
       ...
       [StructLayoutAttribute(LayoutKind.Sequential)]
         ...
         * ***********************/
        [DllImport(@"..\bin\HCNetSDK.dll")]
        public static extern int NET_DVR_FindPicture(Int32 lUserID, ref NET_DVR_FIND_PICTURE_PARAM pFindParam);
        [DllImport(@"..\bin\HCNetSDK.dll")]
        public static extern int NET_DVR_FindNextPicture_V50(Int32 lFindHandle, ref NET_DVR_FIND_PICTURE_V50 lpFindData);
        [DllImport(@"..\bin\HCNetSDK.dll")]
        public static extern bool NET_DVR_GetPicture_V50(Int32 lUserID, ref NET_DVR_PIC_PARAM lpPicParam);
        [DllImport(@"..\bin\HCNetSDK.dll")]
        public static extern bool NET_DVR_GetPicture(int lUserID, string sDVRFileName, [InAttribute()] [MarshalAsAttribute(UnmanagedType.LPStr)] string sSavedFileName);
        [DllImport(@"..\bin\HCNetSDK.dll")]
        public static extern bool NET_DVR_CloseFindPicture(Int32 lpFindHandle);
        #endregion
